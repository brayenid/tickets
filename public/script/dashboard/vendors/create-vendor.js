...
const createVendorForm = $('#create-vendor')

const addVendorBtn = document.querySelector('#add-vendor-btn')
const addVendorLoading = (isLoading) => {
  if (isLoading) {
...
const addVendor = async () => {
  const vendorName = $('#name').value
  const vendorEmail = $('#email').value
  const vendorPhone = $('#phone').value
  const vendorAddress = $('#address').value
  const vendorBirth = $('#birth').value
  const vendorPassword = $('#password').value
